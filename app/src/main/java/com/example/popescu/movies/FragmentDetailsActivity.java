...
public class FragmentDetailsActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        curView = inflater.inflate(R.layout.activity_fragment_details, container, false);
        //  get UI components
    ...
    public static FragmentDetailsActivity newInstance(Movie newMovie) {
        Bundle args = new Bundle();
        FragmentDetailsActivity fragment = new FragmentDetailsActivity();
    ...
    public void updateUI(){
        ...
        boolean favStatus = moviesDB.isFavouriteMovie(getActivity().getContentResolver(), movie.id);
        if (favStatus)
    ...
    class FabOnClick implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String message;
            if (mdb.isFavouriteMovie(contentResolver, movie.id)){
    ...
    public void getTrailers(int id){
        String url = "http://api.themoviedb.org/3/movie/" + id + "/videos?api_key=" + DataApi.API_KEY;
    ...
    public void getReviews(int id){
        String url = "http://api.themoviedb.org/3/movie/" + id + "/reviews?api_key=" + DataApi.API_KEY;
        JsonObjectRequest req = new JsonObjectRequest(url, null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
